# HOSPIA AI Architecture

## Product Frame

HOSPIA AI is a hospitality operating system. The center of gravity is Shift Brain: the venue's operational memory, built from shift reports, service issues, manager actions, employee requests, staff progression, cocktail governance, event planning, and owner intelligence.
...
- If Gemini fails or quota is unavailable, HOSPIA uses a local deterministic fallback generator.
