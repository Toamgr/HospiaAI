...
This folder is the landing zone for extracting the current large `App.jsx` into product-owned modules.
...
- `notifications`: role-filtered notification center.
- `owner-intelligence`: owner command, weekly brief, Business MRI.
