...
The canonical doctrine lives at:
...
Any AI automation idea from this archive must pass HESTIA guardrails before implementation:
...
Use this archive as evidence and context. Do not use it to bypass the HESTIA Skill Pack, the canonical HESTIA Intelligence Doctrine, or the project rules for memory, provenance, and role-safe operational intelligence.

## File Index

| Area | File | Purpose |
| --- | --- | --- |
| README purpose | `README.md` | Defines this folder as a research archive and points to the canonical doctrine. |
| Founder Intelligence | `FOUNDER INTELLIGENCE RESEARCH.md` | Research on founder intent, non-negotiables, values, and internal founder-model language. |
| Guest Intelligence | `GUEST INTELLIGENCE RESEARCH.md` | Research on guest memory, service relevance, personalization limits, privacy, and proportionate guest context. |
| Service Intelligence | `SERVICE INTELLIGENCE HOSPITALITY PSYCHOLOGY RESEARCH.md` | Research on service psychology, hospitality cues, coaching boundaries, and human-control limits. |
