  ...
  return (
    <>
      ...
      <div className="mb-6 grid gap-4 md:grid-cols-3">
        ...
        <Metric label="Busiest Shift Day" value={busiestDay ?? '—'} sub={busiestDay ? 'Most reported shift' : 'Needs more shift reports'} />
        <Metric label="Risk Events" value={alertCount > 0 ? String(alertCount) : 'None'} sub={alertCount > 0 ? 'Flagged alerts in memory' : 'No risks recorded yet'} />
      </div>
